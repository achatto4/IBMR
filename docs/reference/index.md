...
- [`coheterogeneity_Q()`](https://achatto4.github.io/IBMR/reference/coheterogeneity_Q.md)
  : Calculate Coheterogeneity with Fixed- or Random-Weight Standard
  Errors
...
- [`print(`*`<mrpresso_ib>`*`)`](https://achatto4.github.io/IBMR/reference/print.mrpresso_ib.md)
  : Print method for mrpresso_ib

## Example data

- [`toy_ibmr_example`](https://achatto4.github.io/IBMR/reference/toy_ibmr_example.md)
